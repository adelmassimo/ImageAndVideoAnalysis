for i = 1:1    
    ...
    for i = 1:num_persons/2
        ...
        lbpXY = extractLBPFeatures(XYP,'Upright',true, 'NumNeighbors', 16, 'Radius', 4);
        lbpXT = extractLBPFeatures(XTP,'Upright',true, 'NumNeighbors', 16, 'Radius', 4);
        lbpYT = extractLBPFeatures(YTP,'Upright',true, 'NumNeighbors', 16, 'Radius', 4);
